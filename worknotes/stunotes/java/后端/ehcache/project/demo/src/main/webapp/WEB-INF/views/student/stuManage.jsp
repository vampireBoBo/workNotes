				...
				<div class="modal-dialog">
					<div class="modal-content">
							...
							<form class="form form-horizontal" action="" name="updForm" id="updForm" novalidate="novalidate">
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 form-group">
										<label class="control-label col-lg-3 col-md-3 col-sm-3 col-xs-4">性别</label>
										<div class="col-lg-9 col-md-9 col-sm-9 col-xs-8 radio">
											<label><input type="radio" value="0" name="sex" ng-model="updStu.sex" required>男</label>
											<label><input type="radio" value="1" name="sex" ng-model="updStu.sex" required>女</label>
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 form-group">
										<label class="control-label col-lg-3 col-md-3 col-sm-3 col-xs-4">年龄</label>
										<div class="col-lg-9 col-md-9 col-sm-9 col-xs-8">
											<input type="number" min="10" max="40" class="col-lg-8 form-control" name="age" ng-model="updStu.age" placeholder="年龄范围【10-40】" required>                                          
										</div>
									</div>
								</div>
								<div class="row">
						...
						<div class="modal-footer" style="text-align: center;">
							<button class="btn btn-primary" data-dismiss="modal">取消</button>	
							<button class="btn btn-primary" type="reset" >重置</button>
							<button class="btn btn-primary" ng-click="toAddStu()" ng-disabled="!updForm.$valid">提交</button>	
						</div>
					</div>
				</div>
			</div>
